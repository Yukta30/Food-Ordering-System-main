...
2. They also can  easily from the website.
3. Admin can Manage Admin, Caegories and Food Items
4. Admin can also Manage and Track Food  and Delivery


# 🎓 Access the Course
[Click Here](https://www.youtube.com/watch?v=ZBgTzx46B8s&list=PLBLPjjQlnVXXBheMQrkv3UROskC0K1ctW) and Learn to develop a fully functional and dynamic **"Food  System"** with PHP programming language and MySQL Database.
...
2. Install any Text  (Sublime Text or Visual Studio Code or Atom or Brackets)
